`ifndef __ISA_HEADER__
	...
	`define ISA_OP_ANDR		   6'h00 // 寄存器间AND
	`define ISA_OP_ANDI		   6'h01 // 寄存器与常数间AND
	`define ISA_OP_ORR		   6'h02 // 寄存器间OR
	`define ISA_OP_ORI		   6'h03 // 寄存器与常数间OR
	`define ISA_OP_XORR		   6'h04 // 寄存器间XOR
	`define ISA_OP_XORI		   6'h05 // 寄存器与常数间XOR
	...
	`define ISA_OP_SUBUR	   6'h0b // 寄存器与常数间的无符号减法
	...
	`define ISA_IMM_W		   16	 // 立即数的宽度
	`define ISA_EXT_W		   16	 // 符号扩展后的立即数宽度
	`define ISA_IMM_MSB		   15	 // 立即数最高位
	`define IsaImmBus		   15:0	 // 立即数总线
	`define IsaImmLoc		   15:0	 // 立即数位置
	`define ISA_EXP_W		   3	 // 异常代码宽度
	`define IsaExpBus		   2:0	 // 异常代码总线
	`define ISA_EXP_NO_EXP	   3'h0	 // 无异常
	`define ISA_EXP_EXT_INT	   3'h1	 // 外部中断触发的异常
	`define ISA_EXP_UNDEF_INSN 3'h2	 // 未定义指令触发的异常
	`define ISA_EXP_OVERFLOW   3'h3	 // 溢出异常
	`define ISA_EXP_MISS_ALIGN 3'h4	 // 地址未对齐异常
	`define ISA_EXP_TRAP	   3'h5	 // 陷阱异常
	`define ISA_EXP_PRV_VIO	   3'h6	 // 违反权限异常
